...
<body>
 ...
 <!-- <div class="s-section">Analyse</div>
  <ul class="s-nav">
    ...
    <li><a href="notifications.php"><i class="fa-solid fa-chart-line"></i> Activité</a></li>
  </ul>-->
  ...
  <ul class="s-nav">
   ...
   <!--  <div class="sidebar">
      <div class="logo"> GestiDOC</div>
        <h2>Agent</h2>
        <nav class="menu">

          <a href="dashboard.php" class="menu-item active"> <span class="icon"></span>
          <span>Dashboard</span></a>

          <a href="documents.php" class="menu-item active"> <span class="icon"></span>
          <span>Documents</span></a>

          <a href="settings.php" class="menu-item active"> <span class="icon"></span>
          <span>Paramètre</span></a>

          <a href="../profile.php" class="menu-item active"> <span class="icon"></span>
          <span>Mon Profil</span></a>

          <!--<a href="../../auth/logout.php" class="menu-item active"> <span class="icon"></span>
